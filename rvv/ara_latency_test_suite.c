...
void lat_vslide_e32() {
    ...
    vint32m1_t v1 = __riscv_vmv_v_x_i32m1(0, vl);
    start_timer();
    for (int i = 0; i < ITERATIONS; i++) {
...
#define INIT_INT16  __riscv_vmv_v_x_i16m1(1, __riscv_vsetvl_e16m1(1))
...
TEST_LAT_2(vadd_e16,  16, vint16m1_t, INIT_INT16,  __riscv_vadd_vv_i16m1)
...
TEST_LAT_2(vor_e32,   32, vint32m1_t, INIT_INT32,  __riscv_vor_vv_i32m1)

// VFU_Mul
TEST_LAT_2(vmul_e8,   8,  vint8m1_t,  INIT_INT8,   __riscv_vmul_vv_i8m1)
TEST_LAT_2(vmul_e32,  32, vint32m1_t, INIT_INT32,  __riscv_vmul_vv_i32m1)
TEST_LAT_2(vmul_e64,  64, vint64m1_t, INIT_INT64,  __riscv_vmul_vv_i64m1)

// VFU_Div
TEST_LAT_2(vdiv_e32,  32, vint32m1_t, INIT_INT32,  __riscv_vdiv_vv_i32m1)
TEST_LAT_2(vdiv_e64,  64, vint64m1_t, INIT_INT64,  __riscv_vdiv_vv_i64m1)
...
TEST_THROUGH_2(vadd_thru_e64, 64, vint64m1_t, INIT_INT64, __riscv_vadd_vv_i64m1)
